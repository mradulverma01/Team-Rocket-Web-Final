...
const quickFacts = [
  ...
  { value: '100', label: 'BDS admissions' },
  { value: '250', label: 'Modern dental units / chairs' },
  { value: '450-500', label: 'Patients treated daily' }
]
...
const programmeLinks = [
  ...
  { label: 'MDS', to: '/mds' },
  { label: 'Ph.D', to: '/phd' },
  { label: 'Certificate', to: '/certificate-course-in-implantology' }
]
    ...
    <div className="home-page">
      ...
      <section className="home-highlights-section">
        <div className="container highlights-card">
          <div className="section-heading">
            <p className="eyebrow">Admissions &amp; Highlights</p>
            <h2>Admissions, highlights and programme information.</h2>
          </div>
      ...
      <section className="home-spotlights-section">
        <div className="container section-heading">
          <p className="eyebrow">Institution Snapshot</p>
          <h2>Chairman's Desk, College and Hospital.</h2>
        </div>
      ...
      <section className="virtual-tour-section">
        <div className="container virtual-tour-card">
          <div className="section-heading">
            ...
            <h2>Explore the RRDCH campus virtual tour.</h2>
          </div>
