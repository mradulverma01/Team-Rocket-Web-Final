...
const courseLinks = [
  { label: 'Bachelor of Dental Surgery (BDS)', to: '/bds' },
  { label: 'Master of Dental Surgery (MDS)', to: '/mds' },
  { label: 'Ph.D', to: '/phd' },
  { label: 'Certificate Course', to: '/certificate-course-in-implantology' }
]
  ...
  return (
    <footer className="site-footer">
      <div className="institution-strip">
        <div className="container">
          <div className="section-heading section-heading-light">
            <p className="eyebrow">RajaRajeswari Group of Institutions</p>
            <h2>Connected campuses and partner institutions.</h2>
          </div>
      ...
      <div className="footer-accreditation-band">
        <div className="container">
          <p className="footer-accreditation-title">Accreditations &amp; Recognitions</p>
      ...
      <div className="container footer-grid">
        <div className="footer-brand-panel">
          ...
          <p className="footer-tagline">RajaRajeswari Dental College &amp; Hospital</p>
        ...
        <div>
          <h3>Connect</h3>
          <p className="footer-connect-copy">Official social links.</p>
      ...
      <div className="footer-bottom">
        <div className="container footer-bottom-inner">
          <p>&copy; 2013 RRDCH. All Rights Reserved.</p>
          <p>Site Hosted, Designed and Maintained by RRDCH</p>
        </div>
      </div>
    </footer>
  )
