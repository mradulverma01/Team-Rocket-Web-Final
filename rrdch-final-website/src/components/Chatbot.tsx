...
const knowledgeBase: KnowledgeEntry[] = [
  {
    ...
    response: 'For admissions, the fastest next step is the Admission Enquiry page. You can review courses first and then submit your enquiry.',
    actions: [
  ...
  },
  {
    ...
    response: 'RRDCH offers BDS, MDS, Ph.D and Certificate Course options. You can open the course pages directly from here.',
    actions: [
  ...
  },
  {
    ...
    response: 'You can explore campus facilities like hostel, digital library, gymnasium, transportation, classrooms and sports & recreation from the facilities section.',
    actions: [
  ...
  },
  {
    ...
    response: 'You can contact RRDCH at +91-80-2843 7150, +91-80-2843 7468 or +91 9901559955. You can also email principalrrdch@gmail.com.',
    actions: [
...
const Chatbot = () => {
  ...
  const [messages, setMessages] = useState<ChatMessage[]>(() => [
    {
      id: 0,
      sender: 'bot',
      text: 'Hello! I am the RRDCH assistant. I can help with admissions, courses, facilities, contact details and appointment requests.',
  ...
  const handleKnowledgeResponse = (value: string) => {
    ...
    addBotMessage('I can help with admissions, courses, facilities, contact details, ERP access and appointment requests. Try one of the quick options below.', undefined, QUICK_REPLIES)
  }
